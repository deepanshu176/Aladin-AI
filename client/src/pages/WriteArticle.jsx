...
const WriteArticle = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      setLoading(true)
      const prompt = `Write a detailed article of approximately ${selectedLength.length} words on the topic: "${cleanedInput}". Include subheadings, examples, and structured formatting.`
